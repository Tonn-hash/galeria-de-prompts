...
const drawerVariants = cva(
  "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border bg-background",
  {
    variants: {
      direction: {
        top: "inset-x-0 top-0 mt-0 rounded-b-[10px] rounded-t-none",
        bottom: "inset-x-0 bottom-0",
        left: "inset-y-0 left-0 h-full w-3/4 rounded-r-[10px] rounded-l-none",
        right: "inset-y-0 right-0 h-full w-3/4 rounded-l-[10px] rounded-r-none",
      },
    },
    defaultVariants: {
      direction: "bottom",
